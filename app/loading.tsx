        ...
        <main className="flex flex-col mb-10 px-4">
            <div className="min-h-3/4 static flex justify-center p-5 rounded-lg mb-20">
                <div className="static bottom-0 left-0 rounded-lg min-h-96 w-full">
                    <div className="mt-32 py-3 lg:w-1/2 space-y-5">
                        <div className="text-lg font-bold my-3 mx-1 dark:bg-slate-700 bg-slate-300 w-96 animate-pulse h-8 rounded-md"></div>
                        <div className="text-xl text-justify">
                            <div className="text-lg font-bold my-3 mx-1 dark:bg-slate-700 bg-slate-300 animate-pulse h-8 rounded-md"></div>
                            <div className="text-lg font-bold my-3 mx-1 dark:bg-slate-700 bg-slate-300 animate-pulse h-8 rounded-md"></div>
                            <div className="text-lg font-bold my-3 mx-1 dark:bg-slate-700 bg-slate-300 animate-pulse h-8 rounded-md"></div>
                        </div>
                    </div>
            ...
            <div className="flex flex-col space-y-4">
                ...
                <div className="justify-between mb-4">
                    <div className="dark:bg-slate-700 bg-slate-300 animate-pulse h-6 rounded-md w-1/4"></div>
                </div>
            </div>
        </main>
    );
